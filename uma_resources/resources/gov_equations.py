from .helpers import *
from .helpers import thredsholds
import requests
...
def governing_equation_response(material, scenario, emissions,response_json):
    ...
    ** Outputs**
        - One dictionary per group: 
    '''
    molweight = response_json["molecularWeight"]
    total_carbon_atoms = response_json["totalCarbonAtoms"]
    eco_tox = response_json["ecosystemToxicity"]
    human_tox = response_json["humanToxicity"]
...
def nilus_thredsholds(emissions, eco_tox, human_tox):
    ...
    # air
    air_systematic_effect = thredsholds(emissions,human_tox, em_name="Air",eco_name="pInhalationSystemicLong")

    # air
    air_local_effect = thredsholds(emissions,human_tox, em_name="Air",eco_name="pInhalationLocalLong")

    # fresh_water
    fresh_water = thredsholds(emissions,eco_tox, em_name='Fresh water',eco_name='aquaticFreshwater')

    # fresh_water lake
    fresh_water_lake = thredsholds(emissions,eco_tox, em_name='Fresh water lake',eco_name='aquaticFreshwater')

    #ocean_water 
    ocean_water = thredsholds(emissions, eco_tox, em_name='Surface sea/ocean water', eco_name='aquaticMarinewater')

    #marine_sediment 
    marine_sediment = thredsholds(emissions, eco_tox, em_name='Marine sediment', eco_name='aquaticSedimentMarinewater')

    #fresh_sediment
    fresh_sediment = thredsholds(emissions, eco_tox, em_name='Fresh water sediment', eco_name = 'aquaticSedimentFreshwater')
    
    #natural_soil
    natural_soil = thredsholds(emissions, eco_tox, em_name = 'Natural soil', eco_name = 'terrestrialSoil')

    #natural_soil
    agricult_soil = thredsholds(emissions, eco_tox, em_name = 'Agricultural soil', eco_name = 'terrestrialSoil')

    #other_soil
    other_soil = thredsholds(emissions, eco_tox, em_name = 'Other soil', eco_name = 'terrestrialSoil')
